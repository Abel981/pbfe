  ...
  return (
    <>
      ...
      <div className="mx-auto w-full md:w-2/3 md:max-w-2xl md:shadow-xl md:rounded-lg p-5">
        ...
        <Typography
          sx={{ fontSize: "1rem", fontWeight: "semi-bold" }}
          variant="h1"
        >
        ...
        <form onSubmit={handleSubmit(onSubmit)}>
          <div className="flex flex-col gap-2 mb-3 md:flex-row md:items-center ">
            ...
            <div className="flex flex-row flex-grow items-center gap-3">
              <Input
                ...
                className={`ml-6 ${errors.firstName ? "border-red-500" : ""}`}
                id={"firstname"}
              />
              {errors.firstName ? (
                <span className="text-pink-600 inline">Required</span>
              ) : (
                ""
              )}
            </div>
          ...
          <div className="flex flex-col gap-2 mb-3 md:flex-row md:items-center">
            <label htmlFor="middlename" className="w-28">
              Middle Name:
            </label>
            <div className="flex flex-row flex-grow items-center gap-3">
              <Input
                ...
                className={`ml-6 ${errors.middleName ? "border-red-500" : ""}`}
                id={"middlename"}
              />
          ...
          <div className="flex flex-col gap-2 mb-3 md:flex-row md:items-center">
            ...
            <div className="flex flex-row flex-grow items-center gap-3">
              <Input
                ...
                className={`ml-6 ${errors.lastName ? "border-red-500" : ""}`}
                id={"lastName"}
              />
              {errors.lastName ? (
                <span className="text-pink-600 inline">Required</span>
          ...
          <div className="flex flex-row flex-grow items-center gap-3">
            <Input
              ...
              className={`ml-6 ${errors.username ? "border-red-500" : ""}`}
              id={"username"}
            />
            {errors.firstName ? (
              <span className="text-pink-600 inline">Required</span>
          ...
          <div className="flex flex-row flex-grow items-center gap-3">
            <Input
              ...
              className={`ml-6 ${errors.password ? "border-red-500" : ""}`}
              id={"password"}
            />
            {errors.firstName ? (
              <span className="text-pink-600 inline">Required</span>
