...
function SearchFilter({ onCountryChange, onStateChange, onCityChange, onGenderChange, onAgentChange }) {
...
<FormControl fullWidth>
    ...
    <Select value={selectedState} onChange={handleStateChange}>
      <MenuItem value="" onClick={() => setSelectedCountry("")}>States</MenuItem>
      {states.map(state => (
...
<FormControl >
  ...
  onChange={handleAgentTypeChange}
    ...
    name="agentType"
    >
    <FormControlLabel value="simple" control={<Radio />} label="individual" />
    <FormControlLabel value="detailed" control={<Radio />} label="distributed" />
  </RadioGroup>
</FormControl>
